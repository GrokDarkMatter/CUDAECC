...
#ifndef PLFSRSEQ_GFNI_H
#define PLFSRSEQ_GFNI_H

#include <immintrin.h>
#include <stdint.h>

// Prototype for the Reed-Solomon decoder function with palindromic configuration using GFNI
...
extern uint64_t PCErrCnt; // GFNI error counter

// Affine tables for AVX512 GFNI
uint64_t PCAffTab[256] =
