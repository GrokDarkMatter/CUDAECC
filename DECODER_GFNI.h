...
#ifndef DECODER_GFNI_H
#define DECODER_GFNI_H

#include <string.h>
#include <stdio.h>

// Power and log tables for host
unsigned char PCPowTab[] =
{
...
#define gf_mul_GFNI(a, b) (((a) == 0 || (b) == 0) ? 0 : \
        PCPowTab[(PCLogTab[a] + PCLogTab[b]) % 255])

#define gf_div_GFNI(a, b) (((a) == 0 || (b) == 0) ? 0 : \
        gf_mul_GFNI(PCPowTab[255 - PCLogTab[b]], (a)))

#endif // DECODER_GFNI_H